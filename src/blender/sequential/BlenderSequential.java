...
public class BlenderSequential extends Blender{

	public BlenderSequential(BufferedImage img1, BufferedImage img2, GUI window, int[] imageBuffer, MemoryImageSource imageSource) {
